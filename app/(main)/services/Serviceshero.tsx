    ...
    <div className="relative h-[200px] md:h-[320px] overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6 z-10">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          <p className="text-[10px] font-black text-amber-400 uppercase tracking-[0.25em] mb-4">Know more about</p>
          ...
          {/* <p className="text-white/70 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
            From procurement to last-mile delivery  every service we offer is built around one goal: ensuring quality healthcare reaches every citizen in the South West Region.
          </p> */}
        </motion.div>
      </div>
    </div>
